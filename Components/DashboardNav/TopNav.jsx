            ...
            <div className="flex items-center gap-x-[60px]">
                ...
                <div className="flex gap-x-[21px]">
                    ...
                    <div className="flex flex-col items-start ">
                        ...
                        <p className="font-semibold text-[14px] relative "><span className="opacity-70">Member since</span> <span className="text-[#0B63C5]">{new Date(user.createdAt).getFullYear()}</span></p>
                    </div>
                </div>
            </div>
        </div>
