	...
	return (
		<>
			<div className='grid grid-cols-2 gap-x-[68px] gap-y-[37px]'>
				...
				<div className='flex flex-row pl-[32px] py-[55.5px] text-white rounded-[20px]' style={{backgroundColor: card.bgcolor}}>
					<div className='rounded-[27.2px] bg-white px-[16px] py-[16px]'>
						<img src={card.iconpath} className="w-[48px] h-[48px]" alt="" />
					</div>
