  ...
  return (
    <div className="fixed top-0 bottom-0 right-0 left-0 bg-[#000000] z-30 bg-opacity-80 flex items-center justify-center poppinsFont">
      ...
      >
        ...
        <p className="text-[#0B63C5] text-[12px] lg:text-[17.5px] font-semibold text-center mt-[15px] flex gap-x-[11px] items-center justify-center">
        ...
        <div className="flex justify-center px-[30px]">
          <button
            ...
            className="py-[11px] bg-[#0B63C5] w-full max-w-[367px] mt-[18px] text-[12px] lg:text-[16px] rounded-[8px] font-semibold text-white"
          >
