  ...
  return (
    <div className="mt-48 relative xl:w-full sm:h-[1000px] xl:h-[960px]">
      ...
      <div className="absolute md:top-8 lg:top-1 xl:top-10 sm:left-10 md:left-[90px] lg:left-[140px]">
        ...
        <div className="md:top-9 lg:top-32 xl:top-40 sm:left-10 md:left-36 flex flex-row space-x-10 md:pt-[20px] lg:pt-[55px]">
        <div className="">
          <div className="relative">
            <img src="./Images/man.png" alt="" className="rounded-[15px] md:w-[250px] lg:w-[300px] xl:w-[467px] md:h-[350px] lg:h-[450px] xl:h-[650px]"/>
            <div className="absolute md:bottom-5 lg:bottom-10 xl:bottom-20 px-[28px]"> 
              <p className="md:text-[13px] lg:text-[15px] xl:text-2xl sm:[1px] font-bold text-white left-8 right-4 md:pb-1 lg:pb-3">Danny Brown</p>
              <p className="md:text-[10px] lg:text-[15px] xl:text-1xl font-extralight left-8 right-4 md:pb-3 lg:pb-7 text-[#AFAFAF]">Danny Brown</p>
              <p className="md:text-[10px] lg:text-[15px] xl:text-2xl sm:[1px] font-light text-white left-8 right-4">In publishing and graphic design, Lorem ipsum is a placeholder text commonly the visual form of a document or a typeface without relying on meaningful.</p>
            </div>
            <div className="absolute -top-10 md:left-[35%] lg:left-[37%] xl:left-[42%]">
