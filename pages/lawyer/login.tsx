...
const LawyerLoginPage: NextPage = () => {
  ...
  return (
    <div className="w-screen h-screen poppinsFont grid grid-cols-[47%_53%]">
      <div className="relative bg-[url('/Images/lawBalanceImage.png')] bg-cover h-screen w-fullfrom-[#0B63C5] to-[#073D79]">
        <img
        ...
        <div className="ml-[50px] mt-[120px] text-white">
          ...
          <p className="text-[17px] pr-[35px] xl:text-[17px] font-semibold max-w-[460px] mt-[15px]">
            Login to your account to help user get value and solve issues.
          </p>
        </div>
      </div>
        ...
        <div>
          ...
          <form>
            ...
            <button
              ...
              className="w-full text-[20px] text-white py-[18px] xl:py-[22px] rounded-[12px] bg-[#031830]"
            >
              Login
            </button>
          </form>
