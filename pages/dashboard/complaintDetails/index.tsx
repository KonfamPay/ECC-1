			...
			<div className="ml-[27px] mr-[40px] mt-[52px]">
				<div className="flex flex-row space-x-[304.95px]">
					<div className="flex space-x-[10.89px]">
						<p className="text-[20px] text-eccblue font-[600]">
							Greviance ID: 423576275442ecc
						</p>
						<img
					...
					<div className="w-[348px] h-[93.88px] -mt-[33px]">
						<p className="text-[20px] font-[500] float-right">
							Has this complaint been resolved?
						</p>
						<div className="bg-eccblue rounded-[9.375px] w-[150px] float-right mt-[17px]">
							<div onClick={() => setShowModal(true)}>
								<p className="text-[14.06px] text-white py-[12.935px] font-[600] mx-auto text-center cursor-pointer">
									Mark as resolved
								</p>
							</div>
						</div>
				...
				<div className="mt-[14.13px]">
					<div>
						<p className="text-[22px] font-[500]">
							Purchase of fake product from{" "}
							<span className="text-eccblue">Jumia</span>
						</p>
						<p className="text-[20px] mt-[15px] font-[500]">
							You filed this case against{" "}
							<span className="text-eccblue">Jumia</span> on
							02/06/2022
						</p>
					</div>
					<div className="mt-[30px]">
						<p className="text-[20px] leading-[37px] font-[400]">
							As of now iam a distributor of pine tm from vizag
							andhra pradesh as of **** oct all our costumer bills
							got reversed and my money lost no responce from them
							as nearly ****/- lost because of them now there is
							no website of themas of now iam a distributor of
							pine tm from vizag andhra pradesh as of **** oct all
							our costumer bills got reversed and my money lost no
							responce from them as nearly ****/- lost because of
							them now there is no website of them...as of now iam
							a distributor of pine tm from vizag andhra pradesh
							as of **** oct all our costumer bills got reversed
							and my money lost no responce
						</p>
					</div>
				</div>
				<div className="mt-[52px]">
					<p className="text-eccblue text-[19.64px]">
						Resolution wanted:
					</p>
							...
							<div className="bg-clearblue rounded-[10.3831px] w-[558px] h-[306px]">
								...
								<div className="mt-[58px] mx-auto flex space-x-[48px] justify-end mr-[90px]">
									<div
										...
										onClick={() => setShowModal(false)}
									>
										<p className="text-eccblue text-center">
											Cancel
										</p>
									</div>
									<div
										...
										onClick={() => setShowModal(false)}
									>
										<p className="text-center text-white py-[11.5px] px-[40px]">
											Proceed
										</p>
									</div>
								</div>
