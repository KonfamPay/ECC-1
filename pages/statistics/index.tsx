    ...
    <>
      ...
      <div className="bg-clearblue">
        ...
        <div className="relative mx-auto text-center bg-eccblue">
          ...
          <div className="rounded-xl absolute left-[50%] -translate-x-2/4 -bottom-[70px] py-[27px] bg-white max-w-[1159px] w-[80.6%] px-5 hidden lg:block">
            <form className="flex space-x-[20px] items-center justify-between">
              <div className="w-full">
                ...
                <div className="bg-grey-100 rounded-xl flex items-center text-grey-200 cursor-pointer">
                  <div className="flex justify-between py-4 px-4 w-full">
                    <p>Choose a car:</p>
                    <img src="./icons/chevron-down.svg" className="" alt="" />
                  </div>
                  <div></div>
                </div>
              </div>
              <div className="w-full">
                ...
                <div className="relative bg-grey-100 rounded-xl text-grey-200 select-none">
                  <div className="flex justify-between py-4 px-4 w-full cursor-pointer" onClick={() => setShowScam(!showScam)}>
                    <p>
                  ...
                  {showScam && (
                    <div className={`absolute top-[44px] right-0 bg-grey-100 -z-10 rounded-b-xl drop-shadow-md`} data-aos="slide-down" data-aos-offset="100">
        ...
        <div className="bg-clearblue mt-[115px] lg:w-[80%] max-w-[1159px] mx-[12px] sm:mx-9 lg:mx-auto">
            ...
            <div className="w-full bg-white rounded-xl mt-4 lg:mt-5 hidden lg:block">
              <div className="flex flex-row space-x-[190px] pl-[25px] py-[20px]">
                <div className="text-left">
                  <div className="">
                    <p className="text-[25px] font-semibold">$350,000,000</p>
                    <p className="font-light pt-[12px]">Amount Lost</p>
                  </div>
                </div>
                <div className="text-left">
                  <div className="">
                    <p className="text-[25px] font-semibold">150,000,000</p>
                    <p className=" font-light pt-[12px]">Number of Reports</p>
                  </div>
                </div>
                <div className="text-left">
                  <div className="">
                    <p className="text-[25px] font-semibold">18%</p>
                    <p className="font-light pt-[12px]">Reports with financial losses</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="w-full h-[628px] bg-white mr-[141px] mt-[28px] rounded-[12px] hidden lg:block">
              <div>
                <p>Chart goes here</p>
              </div>
            </div>
            <div className="w-full">
              <div className="flex flex-col lg:flex-row lg:space-x-[28px]">
                <div className="w-full h-[429px] lg:h-[752px] bg-white rounded-[12px] mt-[28px]">
                  <p>Chart goes here</p>
                </div>
                <div className="w-full h-[323px] lg:h-[752px] bg-white rounded-[12px] mt-[28px]">
                  <p>Chart goes here</p>
                </div>
              </div>
            </div>
