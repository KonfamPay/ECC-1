          ...
          <div className="flex space-x-[50px] w-full mt-[53px]">
            ...
            <div className="py-[37px] pr-[42px]">
              <p className="text-[20px] text-[#0B63C5] leading-[50px]">
                Use this tool to create an email you can send to the business
                you bought the product or received the service from. If you
                prefer, you can print the letter and send via the post. Remember
                to attach or include any relevant documentation, such as a
                receipt or photo of the faulty product, when you send the
                letter.
              </p>
            </div>
          </div>
        ...
        <div className="mt-[87px]">
            ...
            {shouldInclude && (
              <div className="w-full mt-[20px] bg-[#F1F7FE] rounded-[12px] relative">
                <p className="pt-[28px] pb-[50px] pl-[26px] pr-[76px] text-[20px] text-[#0B63C5]">
                  Use this tool to create an email you can send to the business
                  you bought the product or received the service from. If you
                  prefer, you can print the letter and send via the post
                  thfhhffffhfhfhfhfhfhfhffhfhfhfhfhfhfhhfhfhfhjgkjgfokgffv
                </p>
                <img
                  src="../icons/close.svg"
          ...
          <div className="text-[20px] mt-[44px]">
            <div className="leading-[44px]">
              ...
              <p className="ml-[13px] inline">
                {" "}
                I will lodge a formal complaint with e-commerce complaints(ecc).{" "}
              </p>
              <p className="mr-[9px] inline">
                You can contact me about this complaint via email
              </p>
              <input
                type="email"
                name=""
