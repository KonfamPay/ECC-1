		...
		<div className="poppinsFont">
			...
			<div className="relative w-full mt-[73px] bg-[#031830] pt-[115px] text-white">
				...
				<p className="max-w-[1000px] text-[24px] text-center mx-auto mt-[45px] font-medium">
					{" "}
					Search through over 10,000 scam details .They have scammed
					millions of Naira from Nigerian buyers. Beware of them and
					do not trust them or buy anything from them
				</p>
				<img src="/Images/searchingImage.png" className="mx-auto" />
				<div className="w-full px-[100px] absolute -bottom-[52px]">
					<div className="bg-white flex flex-row max-w-[1160px] mx-auto pl-[59px] pr-[28px] py-[24px] rounded-xl shadow-[2px_2px_15px_-3px_rgba(0,0,0,0.1)]">
						...
						<button
							...
							className="py-[14.5px] px-[48px] bg-[#0A5EBC] rounded-xl active:scale-95 transition-[100ms]"
						>
							Search
						</button>
					</div>
...
mt-[110px] "
			...
			<div className="mt-[100px] w-full bg-[#F1F7FE] pt-[46px] px-[100px]">
				...
				<div className="flex gap-x-[31px] items-center mt-[144px]">
					...
					<p className="text-[20px] text-[#EF2E2E] font-medium ">
						The list is compiled based on inputs from our users. If
						you are a website or phone owner and think that your
						details are wrongly included please contact us so that
						we can remove you. We have taken below factors into
						consideration while categorizing a website as Scam
					</p>
				</div>
			...
			<section className="pt-[88px] pb-[93px] px-[100px] text-center">
				<h1 className="text-[48px] font-semibold">
					How to <span className="text-eccblue">stay away</span> from
					scams
				</h1>
				<LatestScamStep
					number={1}
