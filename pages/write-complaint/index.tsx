      ...
      <div className="mt-[201px] mx-[100px]">
        ...
        <div className="mt-[87px]">
          ...
          <div className="mt-[44px]">
            <textarea name="" id="" className="w-full h-[231px] rounded-xl border-[1px] resize-none outline-none placeholder:text-[18px] placeholder:text-[#838383] px-[20px] py-[25px]" placeholder="Explain what the problem is and what you have done so far to resolve it." />
          ...
          <div className="mt-[44px]">
            <textarea name="" id="" className="w-full h-[231px] rounded-xl border-[1px] resize-none outline-none placeholder:text-[18px] placeholder:text-[#838383] px-[20px] py-[25px] text-[18px]" placeholder="Explain what evidence you are providing to support your complaint, such as your proof of purchase or photographs of the faulty product (you can include this when you send the letter)." />
            <div className="mt-[7px] flex space-x-[10px] px-[10.5px] py-[8px] w-fit rounded-xl bg-clearblue">
          ...
          <div className="mt-[44px]">
            <textarea name="" id="" className="w-full h-[231px] rounded-xl border-[1px] resize-none outline-none placeholder:text-[18px] placeholder:text-[#838383] px-[20px] py-[25px] text-[18px]" placeholder="What would you like the business to do to resolve the issue?)." />
            <div className="mt-[7px] flex space-x-[10px] px-[10.5px] py-[8px] w-fit rounded-xl bg-clearblue">
