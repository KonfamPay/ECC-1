					...
					<div className="flex space-x-[50px] w-full mt-[53px]">
						...
						<div className="py-[37px] pr-[42px]">
							<p className="text-[20px] text-[#0B63C5] leading-[50px]">
								...
								the letter and send via the post. Remember to
								attach or include any relevant documentation,
								such as a receipt or photo of the faulty
								product, when you send the letter.
							</p>
						</div>
					</div>
				</div>
				<div className="mt-[87px]">
						...
						{shouldInclude && (
							<div className="w-full mt-[20px] bg-[#F1F7FE] rounded-[12px] relative">
								<p className="pt-[28px] pb-[50px] pl-[26px] pr-[76px] text-[20px] text-[#0B63C5]">
									...
									you can print the letter and send via the
									post
					...
					<div className="mt-[44px]">
						<p className="text-[20px]">
							I understand that under the Nigerian Consumer Law,
							when I buy products and services they come with
							automatic guarantees that they will work and do what
							I asked for.
						</p>
					</div>
					<div className="mt-[44px]">
						...
						<div className="mt-[7px] flex space-x-[10px] px-[10.5px] py-[8px] w-fit rounded-[12px] bg-[#F1F7FE]">
							...
							<img
								src="./icons/chevron-down.svg"
								className={`cursor-pointer ${
									shouldPurchase && "rotate-180"
								}`}
								onClick={() =>
									setShouldPurchase(!shouldPurchase)
								}
								alt=""
							/>
						</div>
					...
					<div className="text-[20px] mt-[44px]">
						<div className="leading-[44px]">
							<p className="inline">
								If I do not hear from you within{" "}
							</p>
							...
							<p className="ml-[13px] inline">
								{" "}
								I will lodge a formal complaint with e-commerce
								complaints(ecc).{" "}
							</p>
						...
						<div className="bg-[#0B63C5] mt-[102px] mb-[79px] mx-auto w-fit cursor-pointer text-[20px] font-semibold text-white rounded-[12px]">
							<div className="mx-auto px-[193.15px] flex space-x-[20px]">
								<img
									...
									alt=""
								/>
								<p className="py-[22px] text-center">
									Preview Letter
								</p>
							</div>
						</div>
