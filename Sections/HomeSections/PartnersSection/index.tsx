...
const PartnersSection: React.FC = (props) => {
  return (
    <div className="lg:pt-[200px] xl:pt-[100px] pb-[100px] md:pb-[174px] overflow-hidden">
      <h1 data-aos="zoom-in-up" className=" px-[15px] max-w-[500px] lg:max-w-[700px] text-[22px] md:text-[32px] lg:text-[40px] font-semibold poppinsFont mt-[100px] mb-[56px] text-center mx-auto">
