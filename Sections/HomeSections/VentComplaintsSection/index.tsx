...
const VentComplaintsSection : React.FC = (props) => {
	return (
	<>
		<section className="bg-gradient-to-br from-[#0B63C5] via-[#0B63C5] to-[#0953A4] pb-[90px] pt-[60px] lg:pt-[120px]  gap-[100px]">
			<div className="container mx-auto flex flex-col xl:flex-row items-center xl:items-start justify-center">
				<div data-aos="fade-up" className="text-center xl:text-left">
					...
					<button className="py-[18px] sm:py-[26px] px-[30px] sm:px-[60px] text-[18px] font-medium bg-white rounded-[12px] mt-[32px] mb-[32px] mx-auto xl:mx-0">Post a Complaint</button>
				</div>
