...
const Footer : React.FC = (props) => {
    return (
        <footer className="px-[40px] md:px-0 relative flex flex-col md:flex-row items-start md:-left-8 xl:left-0 md:pt-[72px] md:justify-center xl:justify-start pb-[144px]">
